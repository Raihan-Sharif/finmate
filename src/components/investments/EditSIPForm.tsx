        ...
        return (
          ...
          >
              ...
              render={({ field }) => (
                <FormItem>
                  <div className="flex items-center justify-between">
                    <FormLabel className="text-base font-semibold">{t('sipStatus')}</FormLabel>
                    <div className="flex items-center space-x-3">
                      <span className={cn(
                        "text-sm font-medium transition-colors",
                        !field.value ? "text-green-600" : "text-gray-500"
                      )}>
                        {field.value ? t('active') : t('paused')}
                      </span>
                      <FormControl>
                        <Switch
                          checked={field.value}
            ...
            <div className="space-y-2">
              <label className="text-base font-semibold text-gray-700">{t('investmentType')}</label>
              <div className={cn(
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className={cn(
                      ...
                      {t('summary.every')} {form.watch('interval_value')} {form.watch('frequency') ? t(`frequencies.${form.watch('frequency')}`).toLowerCase() : ''}
                    </p>
                  </div>
                </div>
              </motion.div>
      ...
      <Card className={cn(
        ...
        <CardHeader className="text-center pb-6">
          ...
          <div className="flex items-center justify-center space-x-8 mt-6">
            {[
              { key: 'basic', label: t('navigation.steps.basicInfo'), icon: <Edit3 className="h-4 w-4" /> },
              { key: 'schedule', label: t('navigation.steps.schedule'), icon: <Calendar className="h-4 w-4" /> },
              { key: 'advanced', label: t('navigation.steps.settings'), icon: <Settings className="h-4 w-4" /> }
            ].map((stepInfo, index) => {
