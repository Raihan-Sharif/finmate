...
ALTER FUNCTION "public"."admin_get_subscription_payments_count"("p_admin_user_id" "uuid", "p_status" "text") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."admin_get_subscription_payments_count"("p_admin_user_id" "uuid", "p_status" "text") IS 'Get total count of subscription payments for pagination. Includes admin permission validation.';
...
GRANT ALL ON FUNCTION "public"."admin_get_subscription_payments"("p_admin_user_id" "uuid", "p_status" "text", "p_limit" integer, "p_offset" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."admin_get_subscription_payments"("p_admin_user_id" "uuid", "p_status" "text", "p_limit" integer, "p_offset" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_get_subscription_payments"("p_admin_user_id" "uuid", "p_status" "text", "p_limit" integer, "p_offset" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."admin_get_subscription_payments_count"("p_admin_user_id" "uuid", "p_status" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."admin_get_subscription_payments_count"("p_admin_user_id" "uuid", "p_status" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_get_subscription_payments_count"("p_admin_user_id" "uuid", "p_status" "text") TO "service_role";
